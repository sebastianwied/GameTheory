...
import math
from vee_agents_with_threes import *
...
def agent_lst_maker(num_lst):
    ...
    agents_lst = agents_lst + num_lst[7]*[Threes()]
    return agents_lst
...
def input_agent_lst_maker():
    ...
    num_lst.append(int(input('How many THREES: The Cool New IPD Strategy players exist at the start of the simulation?\n')))
